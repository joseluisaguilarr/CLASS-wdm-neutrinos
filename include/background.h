...
struct background
{
  ...
  /* JL */
  double Omega0_wdm; /**< Omega0_ncdm for each species and for the total Omega0_ncdm */
  double Omega0_wdm_tot; /** For classy porpouse I consrved this */
  int WDM_as_BDM;
  double bdm_ac; /**< \f$ \Omega_{0 cdm} \f$: cold dark matter */
  double bdm_vi; /**< \f$ \Omega_{0 cdm} \f$: cold dark matter */
  ...
  /* JL */
  int index_bg_rho_wdm;     /**< density of first wdm species (others contiguous) */
  int index_bg_p_wdm;       /**< pressure of first wdm species (others contiguous) */
  int index_bg_pseudo_p_wdm;/**< another statistical momentum useful in wdm approximation */
  ...
  /* JL */
  short has_wdm;      /**< presence of warm dark matter? */
