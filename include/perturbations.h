...
/* JL */
enum wdmfa_flags {wdmfa_off, wdmfa_on};
...
/* JL */
enum wdmfa_method {wdmfa_mb,wdmfa_hu,wdmfa_CLASS,wdmfa_none};
...
struct perturb_vector
{
  ...
  /* JL */
  int index_pt_delta_wdm; 
  int index_pt_theta_wdm; 
  int index_pt_shear_wdm; 
...
struct perturb_workspace
{
  ...
  */
  ...
  /* JL */
  int index_ap_wdmfa; /**< index for wdm fluid approximation */
